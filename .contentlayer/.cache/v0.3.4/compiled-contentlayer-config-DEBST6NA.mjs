...
// lib/mdx/plugins/index.ts
var remarkPlugins = [remarkGfm, remarkHeading, remarkCode, remarkMath];
var rehypePlugins = [rehypeCode, rehypeInlineCode, rehypeKatex];
...
//# sourceMappingURL=compiled-contentlayer-config-DEBST6NA.mjs.map
