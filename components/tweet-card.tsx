...
export const TweetHeader = ({ tweet }: { tweet: EnrichedTweet }) => (
    <div className='flex flex-row justify-between tracking-tight'>
        <div className='flex items-center space-x-2'>
            ...
            <div>
                <a
                    ...
                    {tweet.user.verified ||
                        (tweet.user.is_blue_verified && <Verified className='ml-1 inline size-4 text-blue-400' />)}
                </a>
        ...
        <a href={tweet.url} target='_blank' rel='noreferrer'>
            ...
            <Twitter className='size-5 items-start text-gray-200 transition-all ease-in-out hover:scale-105' />
        </a>
    </div>
)
