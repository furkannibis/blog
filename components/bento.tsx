export const BentoGrid = () => {
    return (
        <section
            className='bento grid-xl-layout sm:grid-sm-layout xl:grid-xl-layout mx-auto grid max-w-[375px] grid-cols-2 gap-2 *:rounded-3xl *:bg-no-repeat sm:max-w-screen-sm xl:max-w-screen-xl xl:grid-cols-4'>
